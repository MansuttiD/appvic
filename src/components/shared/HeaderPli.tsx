  ...
  return ( 
    <header className="text-[18px] py-2 text-dark_blue overflow-x-hidden">
      <div className="flex justify-between items-center px-2 overflow-x-hidden max-w-xs mx-auto sm:max-w-xl md:max-w-[82rem] ">
          ...
          <li>
              <Link className='text-soft_blue text-[13px]' href="/login">Transacciones</Link>
            </li>
            <li>
              <Link className='text-soft_blue text-[13px]' href="/register">Cuentas</Link>
            </li>
            <li>
              <Link className='text-soft_blue text-[13px]' href="/#">Historial de Tx</Link>
            </li>
          </ul>
        </div>
