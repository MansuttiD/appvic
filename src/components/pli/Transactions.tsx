  ...
  return (
    <section className="general_backgound">
      <div className="flex flex-col align-middle px-5 gap-2 mb-5">
        <h2 className="text-soft_blue font-semibold text-md"> Transacciones</h2>
        ...
        <section className="flex flex-col bg-[#FFF] rounded-3xl justify-between p-6 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] md:flex-col md:items-start">
            ...
            <HiOutlineClock className="text-[#1277DD] text-[18px]" />
            </div>
            <h4><span className="text-[#00BA07]">Buy</span> $9446,3</h4>
        ...
        <section className="flex flex-col bg-[#FFF] rounded-3xl justify-between p-6 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] md:flex-col md:items-start">
            ...
            <h4><span className="text-[#BA0000]">Sell</span> $9446,3</h4>
            <h4>VOTCs Available, Ocucupied</h4>
        </section>
