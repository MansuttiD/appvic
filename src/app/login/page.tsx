      ...
      <div className="p-4 flex justify-center items-center min-h-[calc(100vh-70px)] md:min-h-[calc(100vh-100px)]">
        <div className="p-7 m-4 shadow-lg rounded-2xl bg-white sm:min-w-[600px] lg:min-w-[900px]">
          ...
          <div className='flex justify-center align-middle gap-6'>
            <button className='border-[2px] border-solid boder-[#E7E7E7] rounded-2xl p-2'><FcGoogle className="text-xl"/></button>
            <button className='border-[2px] border-solid boder-[#E7E7E7] rounded-2xl p-2'><BsFacebook className="text-[#3C5A9A] text-xl"/></button>
            <button className='border-[2px] border-solid boder-[#E7E7E7] rounded-2xl p-2'><GrMail className="text-[#9E9E9E] text-xl" /></button>
          </div>
        </div>
      </div>
    </section>
